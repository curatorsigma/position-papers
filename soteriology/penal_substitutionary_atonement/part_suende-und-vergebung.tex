...
%	}
	zum Beweis seiner Gerechtigkeit im Blick das unbestraft lassen der früher geschehenen Sünden
...
TODO Übersetzungskommentar:
- Gesetz ist im ganzen Kontext klar die Torah (das jüdische Gesetz), nicht bloß die Identitätsmarker, und nicht bloß `Gottes guter Maßstab'
- Jesus-Christus-Glauben: Artikel von Grasso zitieren und kurz beschreiben, warum subj und obj nicht gehen
- gerecht machen: offene Skala; es ist Sünde und fehlende Herrlichkeit im Blick, nicht `Übertretung in einer speziellen Situation' oder `Übertretung im Blick des letzten Gerichts'
- Ort der Offenbarung: 
	- Bailey + Porter
	- eigene Notes:
...
TODO Kommentar:
- Nicht Torah macht Menschen gerecht, sondern der Christus-Glaube - der Glaube in Christus (als Gedankensystem)
- Dieses Gerecht-Gemacht-Sein wird allen denen zuteil, die Glauben (loyal zu Christus sind), nicht denen die Werke der Torah tun
- Gott demonstriert durch Jesu Blut (Tod), dass dieses Aus-Glauben-Durch-Jesus-Gerecht-Gemacht-Sein gerecht ist: Jesus ist der Ort, in dem Gott seinem Volk erscheint
	und das Herz der Torah offenbart.
	- Aus diesem Grund war es auch gerecht von Gott die Sünden der früheren Generationen gegen das Gesetz zu übergehen: Gottes Handeln ist das Herz der Torah,
		und diese Tatsache demonstriert er in Christus und darin, dass jetzt Gerecht-Sein außerhalb der Torah möglich ist
- Durch Jesu Wirken ist Gott selbst gerecht, und macht den gerecht, der Teil des Christus-Glauben ist
