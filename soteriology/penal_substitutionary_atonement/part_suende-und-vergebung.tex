...
\chapter{Der Fluch des Bundes, die Strafe des Gesetzes, und der Lohn der Sünde}
TODO Frage:
Ist Die "Strafe des Gesetzes" eine natürliche Konsequenz, genau so wie Tod eine natürliche Konsequenz der Sünde ist?
...
\chapter{\label{fiat}Vergebung durch Fiat}
...
\chapter{Der Messias und sein Opfer im Hebräerbrief}
...
Wir haben bereits im Detail beobachtet, dass Vergebung unabhängig von Blut und Opfern geschehen kann (in Kapitel \ref{fiat}).
...
\begin{description}
	...
	\item[Vergebung von Sünden für die es Reinigungsopfer gab] Auch diese Aussage erscheint kompliziert, aber zumindest fließt sie gut mit dem Argument.
