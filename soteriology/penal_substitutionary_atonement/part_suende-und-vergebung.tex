...
\begin{quote}
  ...
  und wer Unrecht thut, verwirkt selbst sein Leben in Verderben
	denn des Herrn Gerichte sind gerecht gegen Person und Haus.\footnote{
		...
		Wie VanLandingham beschreibt ist hier die Gottes Erbarmen (seine Gnade) gleichbedeutend mit der Errettung als solche, nicht mit einer bestimmten Art und Weise wie
...
tl;dr:
Die δικαι-Wörter können verschiedene Bedeutungen haben.
Wichtig ist hier ein Verständnis ihrer Skalenstruktur: Wenn die Skala geschlossen ist bekommen wir `unschuldig'.
Wenn die Skala offen ist `gerecht' (als Charaktereigenschaft, nicht als gerecht-gesprochen).
Es gibt klare Beispiele wo diese Wörter nicht `Gerechtfertigung' meinen, sondern den Charakter einer Person.

Diskussion über die δικ-Wörter:
Kurze Erklärung von Skalenstruktur - ist die Skala offen oder geschlossen?
- prb nur ein paper dazu zitieren

manchmal forensisch (als gerecht demonstriert / für gerecht befunden):
- LXX Ex 23:7, LXX Dtn 25:1 (und oft in diesem Kontext: du sollt den gerechten für gerecht befinden und den ungerechten für ungerecht)
	- nicht notwendigerweise `für unschuldig erklären', selbst wenn es forensisch ist
- Mt 12:34ff
	- eindeutig im Kontext des letzten Gerichts
	- eindeutig nicht imputation, sondern Offenlegen von einer tatsächlichen Tatsache
	- eindeutig die Basis für den Urteilsspruch ist die tatsächliche Tat/Ausspruch der Person (cf. verdammt in 37)

Manchmal Ontologisch:
LXX Ps 72:13 (MT 73:13)
- δικαιοω eindeutig für `gerecht machen' verwendet (|| in unschuld gewaschen = unschuldig gehandelt)

Lk 1:6
- δικαιος eindeutig als `gerecht', nicht `unschuldig'

1 Kor 6:11
- parallel zu `abgewaschen' und `geheiligt': die vergangene Schuld ist vergeben, und die Person tatsächlich verändert

\section{Gerechtigkeit und das Kreuz im Brief an die Römer}
tl;dr:
Im Römberbrief kommen die beiden letzten Abschnitte prominent zur Geltung: Das Gericht ist nach Werken\bibfoot{Romans}{2}{},
und in diesem Kontext lassen sich auch die folgenden Kapitel verstehen.
Aus Gnade durch Glauben werden Menschen gerecht gemacht - unsere vergangene Schuld wird abgewaschen indem sie mit Christus sterben,
und wir können Gottes Gerechtigkeit erhalten, indem wir im Geist des Christus leben.

\subsection{Römer 2}
tl;dr: Römer 2 ist nicht hypothetisch.
