...
umstritten. Bei der Frage `was meint Paulus mit Gerechtfertigung' existieren mindestens die folgenden Ansichten:
...
\begin{exe}
	...
	\begin{xlist}
		\ex \label{ex:dikaiow-not-transformational} {
			...
			Wenn es zu einem Rechtsstreit zwischen Männern kommt [...], und sie sprechen den Gerechten gerecht, und befinden den Schuldigen für unrecht
		}
...
\subsection{Römer 2 - Gericht nach Werken}
...
\begin{quote}
	es sind nämlich nicht die Hörer der Torah gerecht vor Gott, sondern die Täter der Torah werden gerecht gesprochen werden.
	\attrib{\bibverse{Romans}{2}{13}}
\end{quote}
Es ist in der ganzen Passage (a) das letzte Gericht, und (b) ein klarer Standard in Sicht: Gottes Wille in der Torah offenbart.
...
Das Ausführen der Torah ist nötig, um von Gott im Gericht als gerecht befunden zu werden.
\begin{quote}
	Denn wenn Nationen, die von Natur aus keine Torah haben\footnote{
		Diese Übersetzung ist mit großer Sicherheit korrekt, kontra \Cite{nicnt-romans}.
		Die griechische Phrase ist ἔθνη τὰ μὴ νόμον ἔχοντα φύσει τὰ τοῦ νόμου ποιῶσιν, und die Frage ist, ob φύσει die erste Phrase `Nationen, die die Torah nicht haben',
		oder die zweite Phrase `sie tun die Torah' modifiziert.
		...
		(b) Die Idee, dass Heiden von Natur aus der Torah entsprechend handeln ist inkonsistent mit \bibverse{Galatians}{2}{15}. Heiden sind von Natur aus Sünder, und haben von Natur aus die Torah nicht.
	}, die Torah tun,
	so sind diese, die keine Torah haben, sich selbst Torah.
	Sie beweisen, dass das Werk der Torah in ihren Herzen geschrieben ist
	\attrib{\bibverse{Romans}{2}{14-15}}
\end{quote}
Es gibt also Heiden, die zwar von Natur aus keine Torah haben, aber doch die Dinge der Torah tun.
So beweisen sie, dass Gottes Torah auf ihren Herzen geschrieben ist - die prophetische Hoffnung, die wir schon in Kapitel \ref{chap:prophetische-hoffnung} gesehen haben
und die jetzt durch den Neuen Bund im Christus Jesus offenbart ist.
Und aus diesem Grund zeigen diese Heiden, dass es nicht ausreicht, die Torah zu kennen und zu Proselyten zum Judentum zu werden.\footnote{
	Paulus Zielgruppe sind nicht Juden an sich, sondern Heiden, die versuchen durch das Proselytieren zum Judentum - also indem sie `unter Torah' kommen -
	Zugang zu Gott zu erhalten. Für einer Diskussion über Paulus Adressaten im Römerbrief, siehe \Cite{the-so-called-jew}.
} Diese Heiden, ohne zu Proselyten zu werden, tun Torah in Christus und werden deshalb im Gericht bestehen.
Die `sogenannten Juden'(v17) lassen sich beschneiden und werden in Torah unterrichtet.
Doch Abseits der verändernden Gemeinschaft mit Christus erlangen sie keine Gerechtigkeit.
Diese Verse zeigen, dass es für Paulus sehr wohl möglich ist für einen Menschen, Torah zu erfüllen - nämlich in Christus.
Genau zu diesem Punkt werden wir in der Diskussion über \bibverse{Romans}{8}{3} zurückkehren: ``die Rechtsforderung der Torah wird erfüllt in uns, die wir nicht nach dem Fleisch, sondern nach dem Geist wandeln''.

Ein sehr ähnliches Argument finden wir am Ende des Kapitels:
Paulus beschuldigt Proselyten, die sich auf das Gesetz stützen und trotzdem (und gerade dadurch)\footnote{
	Die Diskussion darüber, wie v22-23 Sinn ergeben führt uns hier zu weit. Siehe wieder \Cite[S.59: Paul's So-Called Jew and Lawless Lawkeeping]{the-so-called-jew}.
}
Böses tun (v17-24), und setzt im Kontrast dazu den Heidenchristen, beschnitten im Herz statt am Körper,
...
klagt den Proselyten an, damit Paulus Argument für Christus-statt-Torah als Basis für die Annahme in Gottes Familie hervorgebracht werden kann.\footnote{
...
\subsection{Römer 3:9-20 - Selbst die Juden unter der Sünde}
...
\begin{quote}
	Was nun? Werden wir benachteiligt?\footnote{
		Ich folge wiederum \Cite[S.94]{the-so-called-jew}: Der hypothetische Sprecher ist ein Heide, der sich nach den letzten Versen fragt,
		ob die Heiden nun im Nachteil gegenüber den Juden sind.
		Die Kraft des griechischen προεχόμεθα ist somit `werden wir (passiv) von den Juden bevorteilt' - haben diese also einen Vorteil gegenüber uns?
	}
	Durchaus nicht! Denn wir haben sowohl Juden als auch Griechen vorher beschuldigt, alle unter der Sünde zu sein,
...
Besonders die protestantische Position löst dieses Problem häufig auf, indem 2:13 hypothetisch gelesen wird: Im Prinzip würden die Täter des Gesetzes durchaus
...
also über den allgemeinen Zustand der Juden\footnote{
	Und durch Argumentation vom großen zum kleinen den Zustand aller Menschen.
	Beachte aber, dass dieser Abschnitt sich explizit um die Juden, bzw. Proselyten dreht (v19)
}, nicht die individuellen Sünden des Lebens am letzten Gericht spricht.
...
Sie zeigen den natürlichen Hang selbst der Juden zur Sünde.
...
Einige der anderen zitierten Stellen beschreiben, dass Menschen vor Gott ungerecht oder schuldig sind, und deswegen Gnade brauchen.\footnote{
...
Paulus will nicht beweisen, dass `alle Menschen aus Sünde an Gott schuldig geworden sind', oder dass `kein Mensch vor Gottes Gericht bestehen kann'.
Das Problem, unter das Paulus hier Juden ebenso wie Griechen einschließt ist, unter der Kraft der Sünde versklavt zu sein,\footnote{
	Ein Punkt, den Paulus immer wieder verwendet, beispielsweise in \bibverse{Romans}{6}{17}.
}
und explizit mit diesem Ziel beginnt er seine lange Folge an Zitaten.
Zu zeigen dass die Juden keinen Vorteil gegen die Heiden haben ist der einführende Grund
durch die Frage seines Gesprächspartners, Paulus' explizit genannter Grund für seine Zitate (v9), und sein explizites Fazit zum Abschluss dieser Text (v19).
...
Wenn unsere Interpretation hier korrekt ist sollte dieses zentrale Problem immer wieder der Kern sein, um den sich Paulus weitere Argumente und seine Lösung drehen.

\subsection{Römer 3:21-26 - Gottes Gerechtigkeit offenbart}
\begin{quote}
...
Einige Kommentare zur Übersetzung an sich sind zunächst nötig.
...
\textbf{Jesus-Christus-Glauben} Die Übersetzung der Phrase πίστεως Ἰησοῦ Χριστοῦ ist äußerst umstritten.
		...
		Die objektive Sicht bedeutet, dass das direkte Objekt des Verbes zum Genitivkonstrukt des deverbalen Substantives wird.
		Wenn das Verb πιστευω allerdings ein direktes Objekt im Akkusativ annimmt, dann ist die Bedeutung immer `an eine Präposition glauben'\footnote{
		...
		Die Bedeutung `Jesus vertrauen' ist in dieser grammatischen Form unmöglich.
		Dass außerdem die eigentliche Präposition, an die geglaubt wird nicht spezifiziert und nicht aus dem Kontext reproduzierbar ist, schließt die objektive Interpretation aus.
		...
		aber das ist in den wichtigsten Stellen in denen die Phrase auftaucht nicht der Fall.
		(b) Es gibt keine Belege dafür, dass griechisch sprechende Leser die Phrase so verstanden haben.
...
(2) als allgemeiner Ort, an dem Opfer gebracht werden\footnote{
	...
	\bibverse{Amos}{9}{1} muss sich auf die obere Fläche eines Altars beziehen.
	...
	Siehe zum Vergleich auch \Cite[2,4]{ignatius-of-antioch-to-the-romans}, wo die wilden Tiere der Altar(θυσιαστήριον) sind, auf dem Ignatius geopfert wird (ἵνα διὰ τῶν ὀργάνων τούτων Θεοῦ θυσία εὑρεθῶ).
	Diese Stelle ist in Formulierung und Bedeutung sehr ähnlich zu \bibverse{IVMaccabbees}{17}{22}: διὰ [...] καὶ τοῦ ἱλαστηρίου τοῦ θανάτου αὐτῶν.
}
...
einfach weil eine deutlich unproblematischere Interpretation existiert.
...
Option (3) ist in der aktuellen Wissenschaft recht unbeliebt, aber tatsächlich deutlich einfacher zu halten als (1b) oder (2).\footnote{
...
Was Jesus tut sollte ein Sünden-Problem lösen und Gottes Gerechtigkeit demonstrieren.

Wenn wir ιλαστηριον in 3:25 als Deckel der Bundeslade mit (1a) \textit{als Ort der Offenbarung} lesen, wie erklärt es dann die Passage im ganzen?
Zunächst sollten wir uns fragen, was Jahwe im Alten Bund an diesem Ort offenbart hat.
...
\textit{Interpretationen und Anwendungen} des Gesetzes auf neuartige Situationen.
...
Der wahre Kern, das echte Herz in Gottes Gesetz findet in Jesus Liebe zu den Menschen un seinem Sieg über die Sünde am Kreuz seinen Ausdruck.
...
Es sind nicht Werke des Gesetzes, sondern der Jesus-Christus-Glauben, der den Menschen befähigt und freisetzt.
...
verbunden mit einer wahrhaft wirksamen Transformation des Herzens, die die Werke der Torah nie vollbringen konnten.\footnote{
	Wir denken hier natürlich auch an \bibverse{Ezekiel}{36}{25-27}.
}

\subsection{Römer 5:9-10 - Gerettet vor Gottes Zorn}
\begin{quote}
	Denn Christus starb, als wir schwach waren: zur rechten Zeit für die Gottlosen.
	Denn kaum wird jemand für den Gerechten sterben. Für den Guten würde vielleicht jemand zu sterben wagen.
	Uns zeigt Gott aber seine Liebe, indem als wir noch Sünder waren Christus für uns gestorben ist.
	Deshalb werden wir viel mehr, wo wir durch sein Blut gerecht gemacht sind, durch ihn vor dem Zorn gerettet werden.
	Wenn wir nämlich, als wir Feinde waren, durch den Tod seines Sohnes mit Gott versöhnt sind,
	werden viel mehr die Versöhnten durch sein Leben gerettet werden.
	\attrib{\bibverse{Romans}{5}{6-10}}
\end{quote}
Paulus Argument in diesen Versen wird angeführt, um zu zeigen wie groß Gottes Liebe für uns ist.
Er ist nicht für gute Menschen gestorben, die seine Hilfe verdient hätten, sondern für schwache, gottlose, ungerechte Sünder.
Für unsere Diskussion interessant ist, dass uns diese Verse eine erneute Zusammenfassung von Jesus Wirken am Kreuz geben.
Das Problem, in dem sich Menschen hier befinden besteht wie wir sehen aus mehreren Facetten:
Wir sind schwach und gottlos, zählen nicht zu den Gerechten oder den Guten.
Die Verse 9-10 geben und zwei parallele Beschreibungen dafür, was Christus an uns tut:
(a) wir sind gerecht gemacht (δικαιωθέντες) und versöhnt (κατηλλάγημεν) durch sein Blut, das ist durch seinen Tod
(b) wir werden vor dem Zorn gerettet durch sein Leben.
Diese beiden Dinge bringt Christus hervor, aber explizit auf zwei verschiedene Arten und Weisen - (a) durch seinen Tod, und (b) durch sein Leben.

Wenn wir zunächst Teil (b) betrachten, finden wir einige andere Verweise auf Gottes Zorn im Verlauf des Römerbriefes bis hierher.
Gottes Zorn ist offenbart gegen die Ungerechtigkeit der Menschen (\bibverse{Romans}{1}{18}),
Menschen häufen ihn sich an für den Tag des Zorns (2:5,8) und sein Zorn steht auch später direkt im Zusammenhang mit Gottes Gericht (3:5, cf. 6).
Der Zorn, vor dem wir gerettet werden müssen ist also Gottes eschatologisches Gericht, das bereits in 1:18-3:20 Paulus
Proklamation der Offenbarung Gottes in 3:21ff vorbereitet hat.
Vor diesem Gericht werden wir hier durch Jesu \textit{Leben} gerettet, und diese Errettung ist etwas anderes als die Versöhnung,
die Jesus durch seinen \textit{Tod} bewirkt.\footnote{
	Wegen diesen Versen sollten wir zumindest sehr vorsichtig sein, unsere Errettung im Blick auf Gottes Gericht ausschließlich
	in Jesu Tod begründet zu sehen.
	Zumindest an dieser Stelle ist es klar, dass Jesu Tod den Prozess beginnt, aber Jesu Leben (NICHT sein Tod) endgültig dafür sorgt,
	dass wir nicht in Gottes Gericht untergehen.
}
Im ersten Schritt versöhnt uns Gott also mit sich selbst, indem er uns aus unserer Sünde und Ungerechtigkeit entfernt -
indem er uns vergibt\bibfoot{Romans}{4}{} und gerecht macht\footnote{3:21ff}.
Da wir nun nicht mehr Gottes Feinde sind, werden wir durch Christus Leben an dem wir teilhaben vor Gottes eschatologischem Gericht bestehen.
Diese selbe Dynamik werden wir nun in zwei weiteren Passagen sehen:
Wir sind in Christus Tod von der Sünde befreit, um in Christus Leben Gott wohlgefällig zu leben.

\subsection{Römer 5-6 - Der Ungerechtigkeit gestorben, in der Gerechtigkeit lebendig}
Die Erlösung von den Sünden nimmt in \bibverse{Romans}{5}{} noch größere Züge an.
Durch die eine Sünde Adams kam Sünde, und durch die Sünde der Tod, zu allen Menschen.
Jetzt aber bringt Gottes Gnade das Leben zu allen Menschen, und besiegt diesen Tod.
Für unsere Frage nach der Gerechtigkeitssprache im Römerbrief ist Vers 19 interessant:
\begin{quote}
	Denn wie durch den Ungehorsam des einen Menschen die Vielen zu Sündern gemacht wurden\footnote{
		\Cite[371]{nicnt-romans} schreibt ``The verb that Paul uses in both phrases (kathistēmi) has a forensic flavor, often meaning `appoint.'
		Here it refers to the fact that people are `inaugurated into' the state of sin/righteousness.
		Paul is insisting that people were really `made' sinners through Adam’s act of disobedience just as they are really `made righteous' through Christ’s obedience.
		But this `making righteous,' in light of the focus throughout this text on one’s state or position,
		means not to become `morally righteous' people but to become `judicially righteous'—to be judged acquitted, cleared of all charges.''

		Dieser Absatz ist linguistisch problematisch: Zunächst hat καθίστημι für Moo einen ``forensic flavor'', als Beispiel gibt Moo aber eine Glosse an,
		die nichts mit einer legalen Deklaration zu tun hat sondern den Amtseintritt eines Würdenträgers beschreibt - eine Glosse, die also hier nicht aktiviert werden kann.
		Dann bedeutet das Verb für ihn `inaugurated', `made', und am Ende `cleared of all charges' (zumindest in Bezug auf die positive Seite des Parallelismus).
		Aber alle diese Bedeutungen sind völlig unterschiedlich!
		Das Wort hat eine große Reichweite an möglichen Bedeutungen, die alle den Beginn eines neuen Zustands beschreiben.
		Unter vielen verschiedenen Glossen listet aber beispielsweise \Cite[καθίστημι]{lsj} keine, die `forensisch' ist und die
		legale Deklaration von Schuld oder Unschuld beschreibt.
		Wir haben vor uns tatsächlich das Versetzen der Vielen in einen neuen Zustand: den von Sündern, oder den von Gerechten.
	},
	so werden durch den Gehorsam des einen die Vielen zu Gerechten gemacht.
	\attrib{\bibverse{Romans}{5}{19}}
\end{quote}
Hier sehen wir wiederum einen Kontrast:
Wo durch Adams Ungehorsam viele Sünder wurden (und dadurch starben), so werden durch Christus Gehorsam viele Gerecht (und dadurch Leben).
Das Problem ist Sünde die zum Tod führt, und die Lösung ist Jesus der uns Gerecht macht und zum Leben führt.

Kapitel 6 führt denselben Kontrast weiter aus: Wir sind ``verwachsen mit Christus Tod'', also werden wir es auch mit seiner Auferstehung sein.
Hier wird deutlich, auf welche Weise Jesu Wirken für den Menschen erfahrbar und verwirklicht wird.
Es ist unser mit-Christus-sterben, was dazu führt, dass wir der Sünde nicht mehr untertan ist (v6).
``Denn wer gestorben ist, ist gerecht gemacht von der Sünde.''\footnote{
	Die transformative Bedeutung von δικαιοω ist hier so zwingend, dass selbst \Cite{nicnt-romans}
	eine Bedeutung des Verbs verwendet, die nicht forensisch ist.
	Die Übersetzungsversuche der \Cite{elb} `freigesprochen' (Text), und `gerechtfertigt' (Fußnote) sind unhaltbar.
	Wenn jeder der stirbt dadurch gerechtfertigt oder freigesprochen ist, warum gibt es dann überhaupt ein Problem, dass Jesus lösen muss?
	Jeder Mensch würde dann automatisch von der Sünde freigesprochen, einfach weil er stirbt.
	Eine Interpretation wie `gerecht gemacht von der Sünde', oder das etwas freiere `befreit von der Kraft der Sünde' sind hier notwendig.
}
Da wir also an Christus Kreuzigung teilhaben, sind wir frei von der Kraft der Sünde und nun fordert uns Paulus auf, auch so zu leben.
Es ist jetzt unsere Entscheidung (ermöglicht durch das Wirken Gottes), uns nicht mehr der Sünde zur Unterechtigkeit, sondern Gott zur Gerechtigkeit
zur Verfügung zu stellen (\bibverse{Romans}{6}{13}).
6:17 resoniert mit unserer neuen Gerechtigkeit durch den Christus-Glauben, indem wir `von Herzen gehorsam geworden sind der Form der Lehre, der wir übergeben worden sind':
Wir sind aus der Kraft der Sünde an eine neue Lehre (nämlich den Christus-Glauben) übergeben durch Jesu Wirken am Kreuz,
deshalb erreichen wir den Gehorsam des Glaubens\bibfoot{Romans}{1}{5}, eines der Ziele zu der Paulus seine Adressaten bewegen will.

\subsection{Römer 8:3 - Gottes Urteil über die Sünde}
Wir schließen unsere Zusammenfassende Diskussion über den Römerbrief in 8:3 ab.
Hier lesen wir:
\begin{quote}
	Denn das dem Gesetz unmögliche, weil es durch das Fleisch kraftlos war \textlangle tat\textrangle\ Gott, indem er seinen eigenen Sohn in Gestalt
	des Fleisches der Sünde und für die Sünde[περὶ ἁμαρτίας] sandte und die Sünde im Fleisch verurteilte.
	\attrib{\bibverse{Romans}{8}{3}, \Cite{elb}}
\end{quote}
Hinter der Phrase περὶ ἁμαρτίας (für die Sünde) versteckt sich der Terminus Technicus, der in der LXX Leviticus verwendet wird,
um das Säuberungsopfer zu bezeichnen.
Doch ein Verweis von 8:3 auf das Säuberungsopfer ist nicht indiziert:
(a) Opfer im levitischen System stehen niemals in einem Zusammenhang mit `Verurteilung',
(b) Paulus verwendet kein Verb, dass für die darbringung von Opfern verwendet wird,
(c) es sind keine kontaminierten Heiligen Gegenstände in Sicht, und
(d) Sünde im Römerbrief ist konsistent ein persönlicher Agent, der Menschen versklavt, und von dem sie gerettet werden müssen.\footnote{
	Siehe z.B. \bibverse{Romans}{5}{21}, 6:21, 6:14, 7:14, 7:11.
	Siehe auch \Cite[S. 257]{lamb-of-the-free}
}
Eine Interpretation mit PSA ist außerdem unmöglich, da hier nicht Jesus, kein Mensch, sonder \textit{die Sünde} verurteilt wird.
Anstatt dass Jesu Kreuzigung also Jesus verurteilt, ist es in Wirklichkeit die Sünde, über die Gericht gehalten wird.
Diese Vollstreckung von Gerechtigkeit über die Sünde hat im Verlauf des Kapitels Folgen:
``Die Rechtsforderung der Torah ist nun in uns, die wir nicht nach dem Fleich, sondern nach dem Geist wandeln, erfüllt.'' (v4)
Hier kommen wir zur Klimax der Transformation, die Jesu Tod bringt: Mit der Sünde ist abgerechnet,
der Gläubige lebt nun im ausgeschütten Geist.
Wir sind Tod für die Sünde mit Jesu Tod, aber lebendig für die Gerechtigkeit mit seinem Leben. (v10)
In dieser neuen Realität können wir durch die Kraft des Geistes die schlechten Handlungen töten (v13),
denn wir sind nicht mehr Sklaven der Sünde, sondern Gottes Söhne (15ff).

Die Sünde ist eine Kraft, unter der Menschen versklavt sind - Jesus ist der Erlöser, der uns aus dieser Sklaverei befreit und uns zu Erben Gottes macht.
